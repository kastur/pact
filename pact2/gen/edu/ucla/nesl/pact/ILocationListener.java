...
public static abstract class Stub extends android.os.Binder implements edu.ucla.nesl.pact.ILocationListener
{
private static final java.lang.String DESCRIPTOR = "edu.ucla.nesl.pact.ILocationListener";
...
/**
 * Cast an IBinder object into an edu.ucla.nesl.pact.ILocationListener interface,
 * generating a proxy if needed.
 */
public static edu.ucla.nesl.pact.ILocationListener asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = (android.os.IInterface)obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof edu.ucla.nesl.pact.ILocationListener))) {
return ((edu.ucla.nesl.pact.ILocationListener)iin);
}
return new edu.ucla.nesl.pact.ILocationListener.Stub.Proxy(obj);
}
...
private static class Proxy implements edu.ucla.nesl.pact.ILocationListener
{
